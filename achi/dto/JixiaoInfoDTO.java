...
public class JixiaoInfoDTO extends PageAssistantBean<JixiaoInfoDTO> implements Serializable {
    /**
     * 标段编号
     */
    ...
    public Integer getTenderProject() {
        return tenderProject;
    }

    public void setTenderProject(Integer tenderProject) {
