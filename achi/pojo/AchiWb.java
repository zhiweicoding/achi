...
public class AchiWb extends PageAssistantBean<AchiWb> implements Serializable {
    ...
    private List<AchiWb> achiWbList;
    ...
    public List<AchiWb> getAchiWbList() {
        return achiWbList;
    }

    public void setAchiWbList(List<AchiWb> achiWbList) {
